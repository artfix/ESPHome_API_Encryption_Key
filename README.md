...
A lightweight static HTML page that generates a 32‑byte base64 encryption key in the browser. 
Double‑click the file or open it in a browser to use it. The key is generated client‑side only; no network requests are made.
